...
export class ProjectsComponent implements OnInit {
  ...
  projects: Project[] = [
    ...
    new Project('Son of Cod', 'C#/.NET', "This is a solo project I chad to complete in an 8 hour window. The prompt was to create a web app that has a home page, the ability sign up for a newsletter, and log in/register admin to view newsletter sign up data. This was made using .NET framework and MSSQL. ", "../../assets/img/project-SOC.png", "https://github.com/Jordloop/SonOfCod", null),
  ]
