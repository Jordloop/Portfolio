...
export class ProjectsComponent implements OnInit {
  ...
  projects: Project[] = [
    ...
    new Project('Symbol', 'Image!', "Place Holder!", "http://u.cubeupload.com/Bompkins/NOwhitesymbol.png", "https://github.com/Jordloop/SonOfCod", null),
  ]
